...
// Exploding crystal
// https://codesandbox.io/s/exploding-crystal-9eeo2?file=/src/App.js:0-1266
...
export default function ExplodingCrystal() {
  return (
    <Canvas
      resize={{ polyfill: ResizeObserver }}
      gl={{ alpha: false }} shadows camera={{ position: [0, 0, 20], fov: 15, near: 1, far: 50 }}>
